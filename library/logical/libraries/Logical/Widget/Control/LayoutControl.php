 ...
 * @since    0.0.25
 */
class LayoutControl implements WidgetControlInterface
{
	/**
	...
	{
		$layoutId = $factory->getVariable($element['data-source'], $displayData);
		...
		return \JLayoutHelper::render($layoutId, $displayData);
	}
}
